...
## 개요
템플릿 메소드 패턴을 활용하여 다중 커머스 플랫폼의 주문 수집 배치 시스템을 설계하고 구축하여 처리 성능을 10배 개선하고 유지보수성을 대폭 향상시켰습니다.

## 문제 상황
**다중 커머스 플랫폼 연동:**
- 위메프, 롯데ON, TMON 등 여러 외부 커머스 플랫폼과 연동
- 각 플랫폼별 API 스펙이 완전히 상이함
...
- **병렬 처리:** CompletableFuture를 활용하여 여러 커머스 동시 수집
